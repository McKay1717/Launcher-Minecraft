  ...
  implements Runnable
{
  ...
  public void downloadFile(String pathFolder) {
		...
		zip.delete();
		System.out.println("Merci d'utiliser ce launcher, decompile et ameliore par almosted , Mis � Jour  Protger et Optimiser  par McKay1717");
}
	      ...
	      for (int i = 0; i < this.urlList.length; i++)
	      {
	        ...
	        while (downloadFile) {
	          ...
	          while ((bufferSize = inputstream.read(buffer, 0, buffer.length)) != -1)
	          {
	            ...
	            this.subtaskMessage = ("R�ception en cours de: " + currentFile + " " + this.currentSizeDownload * 100 / this.totalSizeDownload + "%");
	          ...
	          if (unsuccessfulAttempts < maxUnsuccessfulAttempts) {
	            ...
	            throw new Exception("Echec du t�l�chargement " + currentFile);
	          }
	        }
